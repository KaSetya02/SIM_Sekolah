  ...
  .sekolah:hover{
    color:#fff;
        ...
        <a href="<?php echo base_url(); ?>administrator/home" class="logo">
          ...
          <span class="logo-mini"><img src="../asset/logo/LogoTaruna.png" width="45px"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="../asset/logo/LogoTaruna.png" width="32px">&nbsp<b>SMKS TARUNA WIYATAMANDALA</b></span>
        </a>
